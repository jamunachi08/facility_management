...
def get_data():
    return [
        ...
        {
            "label": _("Utilities & Rent Increments"),
            "items": [
                {"type": "doctype", "name": "Meter"},
                {"type": "doctype", "name": "Meter Reading"},
                {"type": "doctype", "name": "Rental Increment Rule"},
            ],
        },
        {
            "label": _("Security & Workforce"),
            "items": [
                {"type": "doctype", "name": "Facility Shift"},
                {"type": "doctype", "name": "Facility Attendance"},
            ],
        },
        {
            "label": _("Key & Tool Custody"),
            "items": [
                {"type": "doctype", "name": "Facility Key Set"},
                {"type": "doctype", "name": "Facility Tool Set"},
                {"type": "doctype", "name": "Facility Custody Log"},
            ],
        },
        {
            "label": _("Inspections"),
            "items": [
                {"type": "doctype", "name": "Checklist Area"},
                {"type": "doctype", "name": "Property Daily Checklist"},
            ],
        },
        {
            "label": _("Documents"),
